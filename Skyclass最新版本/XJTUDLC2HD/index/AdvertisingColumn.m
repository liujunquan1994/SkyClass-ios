...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //分页控制
        _pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(50, 0, CGRectGetWidth(containerView.frame)-100, 30)];
        ...
        //课程名字
        _imageNum = [[UILabel alloc]initWithFrame:CGRectMake( 120, 0, CGRectGetWidth(containerView.frame)-300, 30)];

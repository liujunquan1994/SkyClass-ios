...
-(NSMutableDictionary *)getNewsJsonData{
    ...
    //httppost地址设置
    NSURL *url = [NSURL URLWithString:@"https://www.xjtudlc.com/iphone_dlc/newlist.php"];
...
-(NSMutableDictionary *)getHLSJsonData{
    ...
    //httppost地址设置
    NSURL *url = [NSURL URLWithString:@"http://202.117.16.193/iphone/hls.php"];
    ...
    [[helper childThreadContext]  performBlockAndWait:^{
        ...
        else
        {
            ...
            while (anObject = [enumerator nextObject]) {
                ...
                NSString *url_str=[[NSString alloc]initWithFormat:@"https://xueli.xjtudlc.com/MobileLearning/learningLog.aspx?%@",str];
...
-(NSString *)getIP{
    ...
    NSString *url_str=[[NSString alloc]initWithFormat:@"https://202.117.16.110:9090/University/tracking/logtest.aspx?p=3"];

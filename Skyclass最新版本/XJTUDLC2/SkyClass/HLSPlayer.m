...
-(NSURL*)getScreenURL
{
    ...
    return [NSURL URLWithString:[[NSString alloc]initWithFormat:@"http://%@:8134/hls-live/location/_definst_/%@/%@.m3u8",_hlsMsg.serverpath,[myarray objectAtIndex:1],[myarray objectAtIndex:0]]];
}
-(NSURL*)getTeacherURL
{

...
-(void)getdata{
   /* NSString *url=[[NSString alloc]initWithFormat:@"http://www.xjtudlc.com/iphone_dlc/news.php?id=%@",_sid];
    ...
    //httppost地址设置
    NSString *url_str=[[NSString alloc]initWithFormat:@"https://www.xjtudlc.com/iphone_dlc/news.php?id=%@",_sid];
    //NSString *url_str = @"http://www.baidu.com";
    NSLog(@"url: %@",url_str);
   ...
   " </style>";
    NSString *mycontent=[[NSString alloc]initWithFormat:@"<html><head>%@</head><body><div class=\"suofang\" style= \"word-wrap : break-word; word-break: normal; width : %dpx; font-size :14px;\"><p style=\"font-weight:bold\">%@</p>%@</div></body></html>",css,(width-20),_title_str,content];
